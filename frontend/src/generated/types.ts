...
export type DeviceCheckResult = number;
...
export interface AllSetting {
  ...
  hwidDefaultLimit: number;
  hwidEnable: boolean;
  hwidForced: boolean;
  hwidGuardManualSub: boolean;
  ...
  shopMaxTopUp: number;
  shopMaxVolumeGB: number;
  shopMinBalance: number;
  shopMinTopUp: number;
  shopPricePerDay: number;
  shopPricePerGB: number;
  smtpCpu: number;
  smtpEnable: boolean;
