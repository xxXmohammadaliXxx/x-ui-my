...
import { z } from 'zod';
export const DeviceCheckResultSchema = z.number().int();
...
export const AllSettingSchema = z.object({
  ...
  hwidDefaultLimit: z.number().int().min(0),
  hwidEnable: z.boolean(),
  hwidForced: z.boolean(),
  hwidGuardManualSub: z.boolean(),
  ...
  salesBotAdmins: z.string(),
  salesBotCurrency: z.string(),
  salesBotEnable: z.boolean(),
  salesBotLang: z.string(),
  salesBotPayText: z.string(),
  salesBotSupport: z.string(),
  salesBotToken: z.string(),
  salesBotWelcome: z.string(),
  sessionMaxAge: z.number().int().min(1).max(525600),
  shopBillingInterval: z.number().int().min(0).max(1440),
  shopConfigDays: z.number().int().min(0),
  shopInboundId: z.number().int().min(0),
  shopJoinChannel: z.string(),
  shopMaxTopUp: z.number().int().min(0),
  shopMaxVolumeGB: z.number().int().min(0),
  shopMinBalance: z.number().int().min(0),
  shopMinTopUp: z.number().int().min(0),
  shopPricePerDay: z.number().int().min(0),
  shopPricePerGB: z.number().int().min(0),
  ...
  subBranding: z.string(),
  subBrandingEnable: z.boolean(),
...
export const ClientSchema = z.object({
  ...
  hwidLimit: z.number().int().optional(),
